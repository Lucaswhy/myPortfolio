    ...
    <div class="div__main ">
      ...
      <div class="div__item">
        ...
        <div class="div__legenda">
          <span>E-commerce em .NET Core + EF</span>
        </div>
      ...
      <div class="div__item">
        ...
        <div class="div__legenda">
          <span>Portfólio de ações com Vuex e Vue-route</span>
        </div>
      ...
      <div class="div__item">
        ...
        <div class="div__legenda">
          <span>Sistema de contas feito todo em Node.js</span>
        </div>
      ...
      <div class="div__item">
        ...
        <div class="div__legenda">
          <span>E-commerce com Node.js, MySQL e Vue.js</span>
        </div>
        <div style="background-color: purple;" class="div__hover">
          <p>Findware</p>
          <p>Projeto em desenvolvimento, um e-commerce com banco de dados relacional (MySQL) onde estou fazendo todo o back-end e há funcionalidades de integração com OAuth 2.0 para login/cadastro com Facebook e Google. Também há uma área administrativa feita no back-end. </p>
          <span><a href="">Projeto ainda não lançado!  <i class="bi bi-box-arrow-up-right"></i></a></span>
        </div>
      </div>
